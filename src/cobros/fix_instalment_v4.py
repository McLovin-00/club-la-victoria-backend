...
# Define the range to replace (line 143 is the first "// 1. Fase 1:", so we start from 144)
start_line = 143  # This is the line number (0-indexed, so 143 means line 144)
end_line = 207    # This is the line number (0-indexed, so 207 means line 208)
